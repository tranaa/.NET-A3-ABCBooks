...
{
    public partial class frmShowBooksByDate : System.Web.UI.Page
    {
        ABCBookStoreRetrieveByDateServiceClient client = new ABCBookStoreRetrieveByDateServiceClient();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet books = client.RetrieveByDate(txtDate.Text).BookSet;
