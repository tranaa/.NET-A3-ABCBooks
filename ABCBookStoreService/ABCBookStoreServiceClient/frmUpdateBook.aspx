<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUpdateBook.aspx.cs" Inherits="ABCBookStoreServiceClient.frmUpdateBook" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Label ID="title" runat="server" Text="Update Book By Title"></asp:Label>
        <br />
        <br />
