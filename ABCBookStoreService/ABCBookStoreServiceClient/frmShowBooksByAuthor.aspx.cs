...
{
    public partial class frmShowBooksByAuthor : System.Web.UI.Page
    {
        ABCBookStoreRetrieveByAuthorServiceClient client = new ABCBookStoreRetrieveByAuthorServiceClient();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet books = client.RetrieveByAuthor(txtAuthor.Text).BookSet;
